...
class MainActivity : AppCompatActivity() {
    ...
    private fun setMove(player: Char, location: Int) {
        ...
        if (player == mGame.HUMAN_PLAYER)
            mBoardButtons[location]?.setTextColor(Color.rgb(100, 200, 1000))
        else
